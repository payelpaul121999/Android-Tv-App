...
class ScreenNameAdapter(
    private val items: List<String>,private val listenerOnItemPressed: (String) -> Unit,
) : RecyclerView.Adapter<ScreenNameAdapter.StringViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StringViewHolder {
        // Inflate the custom layout
        val view = LayoutInflater.from(parent.context).inflate(R.layout.tab_card_item, parent, false)
